...
<div class="container py-3">
    <div class="d-flex justify-content-between align-items-center mb-3" style="margin: 0 25px">
        <h4 style="color: var(--primary-color);">
            <i class="fas fa-clipboard-check mr-2"></i> Les colis que vous avez livré(s)
        </h4>
        <div>
        ...
        @foreach($demandes as $demande)
            <div class="small-demand-card @if($demande->statut_livraison === 'en cours') card-disabled @endif">
                <div class="small-card-header">
                    <span class="small-card-ref">{{ $demande->reference }}</span>
                ...
                <div class="small-card-footer">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="checkbox-container">
                            <label class="checkbox-label"> {{ $demande->livreur->name.' '.$demande->livreur->prenom ?? 'Non defini' }} </label>
                        </div>
                    </div>
                </div>
            </div>
