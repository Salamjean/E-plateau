...
<div class="modern-form-container">
  <div class="form-wrapper">
    <form id="deathDeclarationForm" action="{{ route('statement.update.death', $deceshop->id) }}" method="POST">
      @csrf
      @method('PUT')
      ...
      <div class="form-step active" id="step-1">
        <div class="form-header">
          <h2 class="form-title">Modification de déclaration de décès</h2>
        ...
        <div class="input-grid">
          <div class="input-group">
            ...
            <input type="text" id="nomM" name="NomM" placeholder="Entrez le nom du défunt" value="{{ old('NomM', $deceshop->NomM) }}" required />
            @error('NomM')
          ...
          <div class="input-group">
            ...
            <input type="text" id="prM" name="PrM" placeholder="Entrez le prénom du défunt" value="{{ old('PrM', $deceshop->PrM) }}" required />
            @error('PrM')
            <div class="error-message">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="input-grid">
          <div class="input-group">
            ...
            <input type="date" id="dateNaissance" name="DateNaissance" value="{{ old('DateNaissance', $deceshop->DateNaissance) }}" required />
            @error('DateNaissance')
            <div class="error-message">{{ $message }}</div>
            @enderror
          </div>
          ...
          <div class="input-group">
            ...
            <input type="date" id="dateDeces" name="DateDeces" value="{{ old('DateDeces', $deceshop->DateDeces) }}" required />
            @error('DateDeces')
            <div class="error-message">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="form-section">
          ...
          <div class="radio-group">
            <div class="radio-option">
              <input type="radio" id="choixa" name="choix" value="à" {{ old('choix', $deceshop->choix) == 'à' ? 'checked' : '' }} />
              <label for="choixa">
            ...
            <div class="radio-option">
              <input type="radio" id="choixhors" name="choix" value="hors" {{ old('choix', $deceshop->choix) == 'hors' ? 'checked' : '' }} />
              <label for="choixhors">
                <span class="radio-icon">🏠</span>
                <div class="radio-content">
      ...
      <div class="form-step" id="step-3">
        <div class="form-header">
          ...
          <p class="form-subtitle">Décrivez les circonstances et finalisez la modification</p>
        </div>
        ...
        <div class="form-section">
          ...
          <div class="input-group">
            ...
            <textarea id="remarques" name="Remarques" rows="4" placeholder="Décrivez brièvement les circonstances du décès..." required>{{ old('Remarques', $deceshop->Remarques) }}</textarea>
            @error('Remarques')
            <div class="error-message">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="summary-card">
          ...
          <div class="summary-content">
            <div class="summary-item">
              ...
              <span id="summary-name" class="summary-value">{{ $deceshop->NomM }} {{ $deceshop->PrM }}</span>
            </div>
            <div class="summary-item">
              <span class="summary-label">Date de naissance:</span>
              <span id="summary-birth" class="summary-value">{{ \Carbon\Carbon::parse($deceshop->DateNaissance)->format('d/m/Y') }}</span>
            </div>
            <div class="summary-item">
              <span class="summary-label">Date de décès:</span>
              <span id="summary-death" class="summary-value">{{ \Carbon\Carbon::parse($deceshop->DateDeces)->format('d/m/Y') }}</span>
            </div>
            <div class="summary-item">
              <span class="summary-label">Lieu:</span>
              <span id="summary-location" class="summary-value">{{ $deceshop->choix == 'à' ? 'À l\'hôpital' : 'Hors de l\'hôpital' }}</span>
            </div>
          </div>
        </div>
