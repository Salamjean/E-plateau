...
<body>
    <div class="container py-4">
        <div class="text-center mb-5">
            ...
            <p class="lead">Visualisez et analysez les données des déclarations</p>
        </div>

        <!-- Filtre de Mois -->
        <div class="filter-container">
            <form method="GET" action="{{ route('doctor.stat') }}">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="stat-value text-primary">{{ $naisshop }}</h2>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class=" p-3 rounded-circle" style="background-color: #f72585">
                                <i class="fas fa-cross stat-icon text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="stat-value text-success">{{ $total }}</h2>
                                <p class="mb-0 text-muted">Pour la période sélectionnée</p>
                            </div>
                            <div class="bg-success p-3 rounded-circle">
                                <i class="fas fa-file-medical stat-icon text-white"></i>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-center mb-5">
            <div class="text-center">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <a href="{{ route('doctor.download.stat', ['month' => $selectedMonth, 'year' => $selectedYear]) }}" class="btn btn-download">
        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="chart-container">
                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <h5 class="mb-0 " style="color:#f72585"><i class="fas fa-cross me-2"></i> Décès</h5>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="chart-container">
                    <h4 class="section-title"><i class="fas fa-cross me-2"></i> Évolution des Décès</h4>
