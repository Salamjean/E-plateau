...
<body >
    ...
    <!-- Filtre de Mois -->
<form method="GET" action="{{ route('doctor.stat') }}" class="form-inline mb-3 justify-content-center">
...
<div class="ms-content-wrapper">
  ...
  <div class="form-inline mb-3 justify-content-center text-center">
    ...
    <a href="{{ route('doctor.download.stat', ['month' => $selectedMonth, 'year' => $selectedYear]) }}" class="btn btn-danger mx-2"><i class="fas fa-download"></i> PDF</a>
</div>
<div class="row mb-3">
