...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="page-title"><i class="fas fa-users me-2 mt-4" style="color: var(--primary-color);"></i>Liste des agents financier</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('mairie.dashboard') }}"><i class="fas fa-home"></i> Accueil</a></li>
      <li class="breadcrumb-item active">agent financier</li>
    </ol>
  </div>

  <!-- Première table - Agents financiers -->
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold"><i class="fas fa-user me-2"> </i>Agents financiers</h6>
             ...
             <tbody>
              @forelse ($agents as $agent)
                    <tr style="font-size: 12px" class="text-center">
                        ...
                        <td>{{ $agent->commune }}</td>
                        <td>
                          <span class="timbre-count">
                            {{ abs($agent->timbres->sum('nombre_timbre')) }}
                          </span>
                        </td>
                        <td>
                          <span class="timbre-count">
                            {{ number_format(abs($agent->timbres->sum('nombre_timbre')) * 500, 0, ',', ' ') }} FCFA
                          </span>
                        </td>
                        <td>{{ $agent->cas_urgence }}</td>
                        <td>
                            <a href="{{ route('caisse.finance.export-pdf', $agent->id) }}" class="btn-export">
                        ...
                        <td>
                        <form action="#" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet agent financier ?');" 
                ...
                @empty
                    <tr>
                        <td colspan="10" class="text-center">Aucun agent inscrit</td>
                    </tr>
                @endforelse
            </tbody>
          </table>
