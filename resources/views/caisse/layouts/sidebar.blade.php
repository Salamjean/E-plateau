<ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="{{route('caisse.dashboard')}}" class="nav-link flex-column">
          ...
          <li class="pt-2 pb-1">
            <span class="nav-item-head text-white" style="text-align: center">Responsable : {{Auth::guard('caisse')->user()->prenom}} </span>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('caisse.dashboard')}}">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title text-white">Financier</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu text-white">
                <li class="nav-item text-white" >
                  <a class="nav-link text-white" href="{{route('finance.create')}}">Ajout d'un financier</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link text-white" href="{{route('finance.index')}}">Listes des financiers</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-deces" aria-expanded="false" aria-controls="ui-deces">
              <i class="mdi mdi-crosshairs-gps menu-icon text-white"></i>
              <span class="menu-title text-white">Timbre</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-deces">
              <ul class="nav flex-column sub-menu text-white">
                <li class="nav-item text-white" >
                  <a class="nav-link text-white" href="{{route('caisse.timbre.recharge')}}">Ajout Timbre</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link text-white" href="{{route('caisse.timbre.vente')}}">Timbre Vendu</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link text-white" href="{{route('caisse.timbre.history')}}">Historique generale</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('caisse.timbre.statistiques')}}">
              <i class="mdi mdi-contacts menu-icon text-white"></i>
              <span class="menu-title text-white">Timbres par mois</span>
            </a>
          </li>
