        ...
        <div class="card card-rounded">
            <div class="card-body">
                ...
                <h5 class="section-title">
                    <i class="fas fa-list-check me-2"></i>Historique des demandes
                </h5>
                    ...
                    <table class="table" id="mariageTable">
                        ...
                        <tbody>
                            ...
                            <tr class="animate__animated animate__fadeIn">
                                ...
                                <td>
                                    <strong>{{ $mariage->user ? $mariage->user->name : 'N/A' }}</strong>
                                </td>
                                ...
                                <td>
                                    <span class="badge 
                                        @if($mariage->etat == 'en attente') badge-waiting
                                        @elseif($mariage->etat == 'réçu') badge-received
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        @if ($mariage->etat !== 'réçu' && $mariage->etat !== 'terminé')
                                            <button onclick="confirmDelete('{{ route('user.extrait.mariage.delete', $mariage->id) }}')" 
