        ...
        <div class="card card-rounded">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{route('user.extrait.deces.certificat')}}" class="btn btn-new-request">
                        <i class="fas fa-plus me-2"></i>Nouvelle demande
                    </a>
                </div>

                <!-- Section Demandes avec certificat -->
                <div class="mb-5">
                    <h5 class="section-header">Demandes avec certificat</h5>
                        ...
                        <table class="table select-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong>{{ $deceD->nomDefunt }}</strong><br>
                                        <small class="text-muted">Hôpital: {{ $deceD->nomHopital }}</small>
                                    </td>
                                    <td>
                                        <small>
                                            <strong>Naissance:</strong> {{ $deceD->dateNaiss }}<br>
                                            <strong>Décès:</strong> {{ $deceD->dateDces }}
                                        </small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge 
                                            @if($deceD->etat == 'en attente') badge-warning
                                            @elseif($deceD->etat == 'réçu') badge-success
                                            @else badge-danger @endif">
                                            {{ $deceD->etat }}
                                        </span>
                                        <div class="mt-1">
                                            <span class="retrait-badge">{{ $deceD->choix_option }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @if ($deceD->etat !== 'réçu' && $deceD->etat !== 'terminé')
                                                <button onclick="confirmDelete('{{ route('user.extrait.deces.certificat.delete', $deceD->id) }}')"
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center py-4">Aucune demande avec certificat trouvée</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div>
                    <h5 class="section-header">Demandes pour moi/une tierce personne</h5>
                    <div class="table-responsive">
                        <table class="table select-table">
                            <thead>
                                <tr style="background-color: #1977cc">
