    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                ...
                <p><a href="{{ url('/validate-agent-account/' . $email) }}" style="background-color:#0033c4; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; cursor: pointer;">Valider mon compte</a></p>
