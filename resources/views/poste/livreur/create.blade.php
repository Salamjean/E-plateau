    ...
    <div class="col-lg-10">
      <div class="card signup-card">
        <div class="card-header text-center">
          <h3><i class="fas fa-mail-bulk"></i> Enregistrer un livreur</h3>
        </div>
        ...
        <div class="card-body">
          ...
          <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('delivery.store') }}" novalidate>
            @csrf
            @method('POST')
            ...
            <div class="two-columns">
              ...
              <div class="column">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="commune" id="validationCustom005" placeholder="Lieu de résidence" required>
                  @error('commune')
                  <div class="invalid-feedback d-block">
                    {{ $message }}
                  </div>
              ...
              <div class="column">
                ...
                <div class="mb-3">
                  <label for="validationCustom006" class="form-label">
                    <i class="fas fa-phone-alt"></i> Contact en cas d'urgence
                  </label>
                  <input type="text" class="form-control" name="cas_urgence" id="validationCustom006" placeholder="Numéro d'urgence">
                  @error('cas_urgence')
                  <div class="invalid-feedback d-block">
                    {{ $message }}
                  </div>
