...
<style>
    ...
    table th { background-color: #06634e ; font-weight: 600; color: white }
...
<div class="dashboard-container">
    ...
    <div class="stats-container">
        <div class="stat-card ">
            <div class="stat-title">Total de livreur(s)</div>
            <div class="stat-value">{{ $totalLivreur }}</div>
        </div>
        <div class="stat-card secondary">
        ...
        @else
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{ $activite->reference }}</td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    data: {
        ...
        datasets: [
            { label: 'Livrés', data: @json($chartData['livre']), backgroundColor: '#06634e' },
    ...
    new Chart(document.getElementById('typeChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    {{ $counts['naissance_simple'] + $counts['naissance_certificat'] }},
                    {{ $counts['deces_simple'] + $counts['deces_certificat'] }},
                    {{ $counts['mariage'] }}
                ],
                backgroundColor: ['#06634e', '#f9cf03', '#d4a700']
            }]
        },
