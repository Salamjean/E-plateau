    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
            ...
            <div class="px-6 py-5 "  style="background-color: #0033c4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100 mt-1">Gestion des extraits de naissance</p>
                    </div>
            ...
            <div class="p-6 md:p-8">
                <form action="{{ route('agent.demandes.naissance.update', $naissance->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('POST')
