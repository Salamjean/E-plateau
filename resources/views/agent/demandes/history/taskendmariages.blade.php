...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('agent.dashboard') }}"><i class="fas fa-home"></i> Accueil</a></li>
          ...
          <table class="table align-items-center" id="dataTable1">
           ...
           <tbody>
              @forelse ($taskendmariages as $mariage)
                <tr class="text-center">
                  <td  class="badge bg-success text-white">{{ $mariage->livraison_code ?? 'Retrait sur place'}}</td>
                  <td>
                    <span class="badge 
                      @if($mariage->statut_livraison == 'en attente') badge-warning
                      @elseif($mariage->statut_livraison == 'en cours') badge-success
                      @else badge-danger @endif">
                      {{ $mariage->statut_livraison }}
                    </span>
                  </td>
