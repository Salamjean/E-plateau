<ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="{{route('agent.dashboard')}}" class="nav-link flex-column">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu text-white">
                <li class="nav-item text-white" >
                  <a class="nav-link text-white" href="{{route('agent.declaration.naissance.index')}}">Déclaration</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link text-white" href="{{route('agent.demandes.naissance.index')}}">Demande extrait</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-deces">
              <ul class="nav flex-column sub-menu text-white">
                <li class="nav-item text-white" >
                  <a class="nav-link text-white" href="{{route('agent.declaration.deces.index')}}">Déclaration</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link text-white" href="{{route('agent.demandes.deces.index')}}">Demande extrait</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route('agent.demandes.wedding.index')}}">
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="ui-Historique">
              <ul class="nav flex-column sub-menu text-white">
                <li class="nav-item text-white" >
                  <a class="nav-link text-white" href="{{route('agent.history.taskend')}}">Naissance</a>
                </li>
                <li class="nav-item ">
