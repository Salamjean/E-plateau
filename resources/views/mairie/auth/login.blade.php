...
<head>
    ...
    <title>Mairie plateau login</title>
    <style>
        :root {
...
<body>
    <form class="form-container animate__animated animate__fadeIn" method="POST" action="{{route('mairie.handleLogin')}}">

        <div class="form-header">
            <h1 class="title">Mairie plateau</h1>
