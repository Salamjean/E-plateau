    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold"><i class="fas fa-user me-2"> </i>Le service de livraison du plateau</h6>
          ...
          <table class="table align-items-center" id="dataTable1">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Lieu du résidence du responsable</th>
