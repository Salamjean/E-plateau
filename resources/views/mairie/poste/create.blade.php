    ...
    <div class="col-lg-8">
      <div class="card signup-card">
        <div class="card-header text-center">
          <h3>Enregistré le service de livraison</h3>
        </div>
        ...
        <div class="card-body">
          ...
          <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('post.store') }}" novalidate>
            @csrf
            @method('POST')

            <div class="row mb-4">
              <div class="col-md-6 mb-3">
                <label for="validationCustom001" class="form-label">Nom de l'administrateur</label>
              ...
              <div class="col-md-6 mb-3">
                <label for="validationCustom002" class="form-label">Prénoms de l'administrateur</label>
            ...
            <div class="row mb-4">
              <div class="col-md-6 mb-3">
                <label for="validationCustom003" class="form-label">Email du service</label>
              ...
              <div class="col-md-6 mb-3">
                <label for="validationCustom004" class="form-label">Contact du service</label>
            ...
            <div class="mb-4">
              <label for="validationCustom005" class="form-label">Situation géographique du service</label>
              <input type="text" class="form-control" name="commune" id="validationCustom005" placeholder="Entrez la Situation géographique de la poste" required>
              @error('commune')
              <div class="invalid-feedback d-block">
                {{ $message }}
              </div>
