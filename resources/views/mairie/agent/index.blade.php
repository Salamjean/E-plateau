...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="page-title"><i class="fas fa-users me-2 mt-4" style="color: var(--primary-color);"></i>Liste des agents d'état civil</h1>
    <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold"><i class="fas fa-user me-2"> </i>Agents d'état civil</h6>
