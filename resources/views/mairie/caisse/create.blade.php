    ...
    <div class="col-lg-8">
      <div class="card signup-card">
        <div class="card-header text-center">
          <h3>Inscrire un nouvel agent de finance municipal</h3>
        </div>
          ...
          <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('caisse.store') }}" novalidate>
            ...
            <div class="row mb-4">
              <div class="col-md-6 mb-3">
                <label for="validationCustom001" class="form-label">Nom du financier</label>
              ...
              <div class="col-md-6 mb-3">
                <label for="validationCustom002" class="form-label">Prénoms du financier</label>
