                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-actions">
                            <a href="{{ route('finance.timbre.history') }}" class="btn btn-sm btn-icon" data-bs-toggle="tooltip" title="Actualiser">
                                ...
                                <tr>
                                    <td colspan="5" class="text-center">
                                        <div class="empty-state">
                                            ...
                                            <a href="{{ route('finance.timbre.history') }}" class="btn btn-outline">
                                                Actualiser
                                            </a>
                                        </div>
                                    </td>
