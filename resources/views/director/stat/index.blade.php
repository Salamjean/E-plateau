@extends('director.layouts.template')
...
<h4 class="text-center">Les statistiques par mois</h4>
 <form method="GET" action="{{ route('directeur.index.stat') }}" class="form-inline mb-3 justify-content-center">
...
<div class="row w-full mt-4">
  ...
  <div class="form-inline mb-3 justify-content-center text-center">
    <a href="{{ route('directeur.download.stat') }}" class="btn btn-danger mx-2"><i class="fas fa-download"></i> PDF</a>
</div>
<div class="row mb-3">
