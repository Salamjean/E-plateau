...
<br><br>
    <h4 class="text-center">Statistiques par mois</h4>
      <!-- Filtre de Mois -->
  <form method="GET" action="{{ route('hopital.stat') }}" class="form-inline mb-3 justify-content-center">
...
<div class="row w-full mt-4">
  ...
  <div class="form-inline mb-3 justify-content-center text-center">
    <a href="{{ route('hopital.download.stat') }}" class="btn btn-danger mx-2"><i class="fas fa-download"></i> PDF</a>
