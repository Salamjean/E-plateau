        ...
        <div class="col-xl-12 col-md-12">
            <div class="ms-panel">
                <div class="ms-panel-header ms-panel-custome">
                    <h6 class="text-white">Ajout d'un personnel</h6>
                    <a href="{{ route('doctor.index') }}" class="add-patient">
                        <i class="fas fa-bars"></i>  Liste des personnels
                    </a>
                </div>
                <div class="ms-panel-body">
                    <form class="needs-validation modern-form" method="POST" enctype="multipart/form-data" action="{{ route('doctor.store') }}" novalidate>
                        @csrf
                        @method('POST')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control modern-input" name="name" value="{{ old('name') }}" id="validationCustom001" placeholder="Entrez son nom" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control modern-input" name="prenom" value="{{ old('prenom') }}" id="validationCustom002" placeholder="Entrez son prénom" required>
                                    <div class="valid-feedback">correct</div>
                                </div>
                                @error('prenom')
                                    <div class="text-danger text-center error-message">{{ $message }}</div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control modern-input" name="email" value="{{ old('email') }}" id="validationCustom003" placeholder="Entrez son email" required>
                                    <div class="valid-feedback">Correct</div>
                                </div>
                                @error('email')
                                    <div class="text-danger text-center error-message">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control modern-input" name="contact" value="{{ old('contact') }}" id="validationCustom009" placeholder="Son contact" required>
                                    <div class="valid-feedback">Correct</div>
                                </div>
                                @error('contact')
                                    <div class="text-danger text-center error-message">{{ $message }}</div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control modern-textarea" name="description" id="validationCustom005" placeholder="Décrivez le personnel" required style="height: 150px;"></textarea>
                                    <div class="valid-feedback">Correct</div>
                                </div>
                                @error('description')
                                    <div class="text-danger text-center error-message">{{ $message }}</div>
