...
<div class="extrait-page">
    ...
    <section class="extrait-tabs">
        <div class="extrait-container">
            <div class="tabs">
                <button class="tab-btn active" data-tab="avec-certificat">Demande avec certificat médical</button>
                <button class="tab-btn" data-tab="simple-integral">Demande simple ou intégral</button>
            </div>
        </div>
    </section>
    ...
    <div class="extrait-container">
        ...
        <div class="tab-content active" id="avec-certificat">
        ...
        <!-- Simple ou Intégral -->
        <div class="tab-content" id="simple-integral">
            <div class="extrait-card">
                <div class="card-header">
