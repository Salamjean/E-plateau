...
class StatistiqueController extends Controller
{
    ...
    {
        $sousadmin = Auth::guard('director')->user();
        ...
        if ($request->has('download_pdf')) {
            $pdf = PDF::loadView('director.stat.pdf', compact('naisshop', 'deceshop', 'total', 'selectedMonth', 'selectedYear', 'naissData', 'decesData'));
            return $pdf->download('statistiques_director.pdf');
        }

        return view('director.stat.index', compact('naisshop', 'deceshop', 'docteur', 'total', 'selectedMonth', 'selectedYear', 'naissData', 'decesData'));
    }
    ...
    public function download(Request $request)
    {
        ...
        // Générer le PDF
        $pdf = PDF::loadView('director.stat.pdf', $data);
